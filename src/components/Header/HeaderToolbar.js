...
import { Toolbar, ToolbarRow, ToolbarSection, Display1 } from 'react-mdc-web';
...
export default class HeaderToolbar extends Component {
  render() {
    return (
      <Toolbar
        style={{ paddingLeft: '2vh', paddingRight: '2vh', maxHeight: '10vh' }}
      >
        <ToolbarRow>
          ...
          <ToolbarSection align="end">
            <ToolBarImage
              onClick={this.props.openAvatarMenu}
